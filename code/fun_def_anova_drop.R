...
cat(paste0("There are variables which don't meet the p-value < 0.05 treshold in the anova, pruning necessary.\n"))
...
if(to_drop_var %in% sig_vec){
  cat("The variable with the highest p-value is involved in an interaction!!! Manual thinking needed. Sorry!")
  to_drop_var <- NULL
}
