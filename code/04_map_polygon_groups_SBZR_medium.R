...
#this script makes map that show which islands are included in which grouping. There are two groupings: "Marck" and "medium" (Medium_only_merged_for_shared_language). 
...
#read in glottolog-cldf table (generated by script in this repos)
