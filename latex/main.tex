...
The list below specifies further settings of the model.
...
\caption{Coefficient distribution of BRMS model, using overnight sailing distances island groups with all observations. Distributions where the 95\% confidence interval straddles zero are marked as more transparent.}
