...
\FloatBarrier
\subsection{Ridgeplot of effects}
...
\FloatBarrier
\subsection{Prediction boxplots}
...
\FloatBarrier
\subsection{Barplots of difference between predicted and observed when one island group is dropped}
...
\FloatBarrier
\subsection{SPLOM of all variables per island grouping}
